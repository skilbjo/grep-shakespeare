// "Create a function that adds three numbers and return the average of all the numbers."

// Assert function to test your function

function assert(expectedBehavior, messageAboutExpectedBehavior) {
  if (!expectedBehavior) {
    console.log(messageAboutExpectedBehavior);
  } else {
...
// this is a valid amex number "343456789012345"
